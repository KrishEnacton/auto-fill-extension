    ...
    <div className="w-[600px]">
      ...
      <div className="mt-2 w-[800px]">
        <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset bg-white focus-within:ring-base">
          <span className="flex select-none rounded-l-md items-center px-3 bg-gray-100 ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset text-gray-500 sm:text-lg">
            {baseUrl}
          </span>
          <input
            type="text"
