              ...
              >
                <Dialog.Panel className='w-full max-w-md transform overflow-hidden  rounded-2xl bg-custom_white text-custom_black p-6 text-left align-middle shadow-xl transition-all'>
                  ...
                  <div className='mt-4 gap-x-4 justify-end flex'>
                    <button
                      type='button'
                      className='inline-flex justify-center rounded-md border border-transparent px-4 py-2 text-sm bg-secondary_button font-bold text-secondary_text focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2'
                      onClick={confirm}
                    >
